...
> Each item traces to its source in `_reversa_sdd/` and respects `paradigm_decision.md`.
...
## Notes
<Curator's general observations. Items that will be consolidated in `ambiguity_log.md`.>
